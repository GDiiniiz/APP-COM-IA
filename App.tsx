...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.button} onPress={hanlerGenerate}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24 }} style={styles.containerScroll} showsVerticalScrollIndicator={false}>
        {loading && (
